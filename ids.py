...
def process_packet(packet):
    ...
    if packet.haslayer(IP):
        ...
        attack_type = classify_attack(packet_count[src])
...
# ---------------- GUI ----------------
root = tk.Tk()
root.title("Advanced IDS + IPS Dashboard")
root.geometry("800x550")

title = tk.Label(root, text="🛡️ Intrusion Detection & Prevention System", font=("Arial", 16))
title.pack(pady=5)
